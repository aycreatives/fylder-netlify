    ...
    >
      ...
      <div className="bg-white my-8 z-10 p-8  rounded shadow-md w-full max-w-md">
        ...
        >
          {step === 1 && (
            <>
              ...
              <button
                type="submit"
                className="submit bg-sky-600 text-xl h-[50px] text-white py-2 mt-5 rounded w-full cursor-pointer flex items-center justify-center"
              >
                Next
              </button>
            </>
          ...
          {step === 2 && (
            <>
              ...
              <button
                type="button"
                className="mt-3 text-sky-600 underline"
                onClick={() => setStep(1)}
                disabled={loading}
              >
                Back
        ...
        <p className="mt-5 text-center">
          ...
          <NavLink to="/login" className="text-sky-600 text-[16px] font-bold">
