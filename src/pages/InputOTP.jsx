...
const InputOTP = ({ onSubmit }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 px-4">
      ...
      >
        <h2 className="text-2xl font-bold mb-2 text-sky-700">Enter OTP</h2>
        ...
        <button
          type="submit"
          className="cursor-pointer bg-sky-500 hover:bg-sky-600 text-white font-semibold px-6 py-2 rounded transition w-full"
          disabled={loading}
        >
