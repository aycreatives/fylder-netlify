...
export default function PersonalisationHistory() {
  ...
  const apiLink = `${config.apiBaseUrl}${config.endpoints.DemographicSearchHistory}${userId}`;
      ...
      <div className="grid grid-cols-2 gap-4 text-sm">
        ...
        <div className="space-y-2">
          <div>
            ...
            <span
              className={`mt-1 px-2 py-1 text-xs  rounded-full ${getStatusClass(
                transaction.status
              )}`}
            >
              {transaction.status}
                    ...
                    {paginatedData.map((transaction) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 whitespace-nowrap">
                          <span
                            className={`px-3 py-1 uppercase inline-flex text-xs leading-5  rounded-full ${getStatusClass(
                              transaction.status
                            )}`}
                          >
                            {transaction.status}
                        ...
                        <td className="px-4 py-3 whitespace-nowrap">
                          <button
                            onClick={() => showModal(transaction)}
                            className="text-blue-600 hover:text-blue-800 transition-colors p-2 rounded hover:bg-blue-50 flex items-center gap-1"
                            title="View Details"
                          >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-900 mt-1">
                          {selectedTransaction.gender || "N/A"}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                    ...
                    <div>
                      ...
                      <span
                        className={`mt-10 px-3 py-1 text-xs  rounded-full ${getStatusClass(
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900 mt-1">
                      {selectedTransaction.serialNumber || "N/A"}
                    </p>
                  </div>
