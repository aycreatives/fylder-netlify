  ...
  return (
    <div className="w-full rounded-2xl mb-10 bg-white p-5 shadow-lg">
      ...
      <form action="#" method="post">
        ...
        <div>
          ...
          <label class="flex items-center mt-8 space-x-2 cursor-pointer">
            <input
              type="checkbox"
              required
              class=" h-4 w-4 rounded border-gray-100 text-sky-500 focus:ring-sky-500 bg-sky-500"
            />
        ...
        <button
          type="submit"
          className="flex items-center text-xl mt-10 mb-8 cursor-pointer justify-center gap-2 bg-sky-500 hover:bg-sky-600 text-white font-medium py-2 px-4 rounded-xl w-full h-[50px] transition-colors"
        >
